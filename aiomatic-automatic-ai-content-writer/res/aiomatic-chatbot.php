...
<div class="wrap gs_popuptype_holder seo_pops">
    ...
    <nav class="nav-tab-wrapper">
        ...
        <a href="#tab-12" class="nav-tab"><?php echo esc_html__("Chatbot Interface", 'aiomatic-automatic-ai-content-writer');?></a>
...
<table class="widefat">
    ...
    <h2><?php echo esc_html__("Chatbot Extension Settings:", 'aiomatic-automatic-ai-content-writer');?></h2>
        ...
        <tr><td colspan="2"><span class="cr_red"><?php echo esc_html__("Warning! This feature is currently supported only for OpenAI models (excepting gpt-3.5-turbo-instruct). Each extension will use some additional input tokens, which will be sent to the AI in each request. So, using extensions will increase also costs of API usage. Be sure to activate only the extensions which you need!", 'aiomatic-automatic-ai-content-writer');?></span></td></tr>
        <tr><td colspan="2">
    <hr/>
        </td></tr>
        <tr><td>
