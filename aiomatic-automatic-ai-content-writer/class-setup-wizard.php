...
class Aiomatic_Setup_Wizard {
    ...
    public function setup_wizard_header() {
        ...
        <head>
            ...
            <?php remove_action( 'admin_head', 'wp_enqueue_admin_bar_header_styles' );do_action( 'admin_head' );add_action( 'admin_head', 'wp_enqueue_admin_bar_header_styles' );?>
        </head>
