...
function aiomatic_get_god_mode_function()
{
    ...
    $wp_god_mode = aiomatic_return_god_function_assistants($god_mode, $dalle, $stable, $midjourney, $replicate, $amazon, $amazon_details, $scraper, $rss, $google, $captions, $royalty, $youtube, $email, $facebook, $facebook_image, $twitter, $instagram, $pinterest, $business, $youtube_community, $reddit, $linkedin, $webhook, $stable_video);
...
function aiomatic_edit_submit() {
    ...
    {
        $aiomatic_result['msg'] = 'Incomplete POST request for text editing ' . print_r($_POST, true);
        wp_send_json($aiomatic_result);
    }
	$instruction = stripslashes($_POST['instruction']);
	$input_text = stripslashes($_POST['input_text']);
